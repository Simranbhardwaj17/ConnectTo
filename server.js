...
// require('dotenv').config();                // Load .env Variables using dotenv
...
const PORT = process.env.PORT || 8000; //put the port in a var  (it will look for an environment var called PORT to use & when deployed ,tht's where it's gonna get the port no, locally run on port 5000)
