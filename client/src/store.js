...
const store = createStore(      //create a variable called store set that to createStore, which we brought in from Redux. And this is gonna take in, first of all, the root reducer. and then the initialState, and then any middleware.
  rootReducer,
  initialState,
